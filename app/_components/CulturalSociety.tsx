          ...
          {culturalSocietyData.map((club, i) => {
            ...
            return (
              <Reveal key={i} delay={100 * (i % 4)}>
                {/* Wrapped in Link to match TechnicalSociety */}
                <Link
                  href={`/clubs/${clubSlug}`}
                ...
                >
                  <Image
                    src={`/${club.img}`}
                    alt={club.name}
                    width={72} // Fixed: Changed from 17.5 to whole number
                    height={72} // Fixed: Changed from 17.5 to whole number
